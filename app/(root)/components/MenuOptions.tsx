...
export default function MenuOptions({ title, children }: MenuOptionProp) {
  return (
    <div className="group flex min-w-max  flex-col items-center justify-center gap-2 rounded-2xl border border-slate-800 px-1 py-4 font-bold text-slate-700   hover:scale-110 hover:bg-slate-800">
